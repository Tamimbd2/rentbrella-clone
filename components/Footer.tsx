      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-8">
            <div className="col-span-2 lg:col-span-1">
                 <h4 className="font-bold text-lg mb-4">Rentbrella</h4>
            ...
            <div>
                ...
                <ul className="space-y-2">
                     <li>
                        <a href="mailto:contact@rentbrella.com" className="text-gray-400 hover:text-white transition-colors text-sm">contact@rentbrella.com</a>
                    </li>
                </ul>
            </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center text-center">
            ...
            <p className="text-gray-500 text-xs">&copy; {new Date().getFullYear()} Rentbrella Brasil LTDA - CNPJ/MF sob n° 25.020.976/0001-57</p>
        </div>
      </div>
    </footer>
  );
