...
const Contact: React.FC = () => {
  return (
    <section className="bg-brand-bg-light py-20 lg:py-28">
        ...
        <form className="mt-12 bg-white p-8 md:p-12 rounded-lg shadow-xl">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                    <SelectField label="Where did you hear about Rentbrella?*" options={['Select option', 'Social Media', 'News', 'Friend', 'Event', 'Google']} />
                </div>
                 <div className="md:col-span-2">
                ...
                <div className="md:col-span-2">
                 ...
                 <div className="md:col-span-2 flex items-start">
                    ...
                    <label htmlFor="agree" className="ml-2 block text-sm text-gray-600">
                        I agree to the processing of my personal data for the purpose of receiving advertising materials and content related to Rentbrella's products and services.
                    </label>
                </div>
